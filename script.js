...
const dataOnFolder = path.join(homeDir, 'data.json');

fs.writeFile(dataOnFolder, data, (err) => {
    if (err) {
        console.error(err);
    } else {
        console.log('Data written to file:', dataOnFolder);
    }
});
...
updateDataJsonFile(dataOnFolder, newData);